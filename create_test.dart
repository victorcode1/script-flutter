...
void main() {
  ...
  testUsingContext('can create a victordev (list/detail) app', () async {
    await _createAndAnalyzeProject(
      projectDir,
      <String>['-t', 'victordev', '-i', 'objc', '-a', 'java', '--implementation-tests'],
      <String>[
...
1) 86f7e437faa5a7fce15d1ddcb9eaeaea377667b8 "iPhone Developer: Profile 1 (1111AAAA11)"
  ...
  testUsingContext('should show warning for incompatible Java/template Gradle versions when detected', () async {
    ...
    final CreateCommand command = CreateCommand();
    final CommandRunner<void> runner = createTestCommandRunner(command);
    final List<FlutterProjectType> relevantProjectTypes = <FlutterProjectType>[FlutterProjectType.victordev,FlutterProjectType.app, FlutterProjectType.skeleton, FlutterProjectType.module];
    ...
    for (final FlutterProjectType projectType in relevantProjectTypes) {
      ...
      if (projectType == FlutterProjectType.app || projectType == FlutterProjectType.skeleton|| projectType == FlutterProjectType.victordev) {
  ...
  testUsingContext('should show warning for incompatible Java/template AGP versions when detected', () async {
    ...
    final CreateCommand command = CreateCommand();
    final CommandRunner<void> runner = createTestCommandRunner(command);
    final List<FlutterProjectType> relevantProjectTypes = <FlutterProjectType>[FlutterProjectType.app, FlutterProjectType.skeleton,FlutterProjectType.victordev, FlutterProjectType.pluginFfi, FlutterProjectType.module, FlutterProjectType.plugin];
    ...
    for (final FlutterProjectType projectType in relevantProjectTypes) {
      ...
      if (projectType == FlutterProjectType.app || projectType == FlutterProjectType.skeleton  || projectType == FlutterProjectType.victordev|| projectType == FlutterProjectType.pluginFfi) {
